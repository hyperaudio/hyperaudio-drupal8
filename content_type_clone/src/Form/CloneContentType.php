...
class CloneContentType {
   ...
   *   A reference to the batch operation context.
   */
  public static function copyContentTypeNode(int $nid, array $values, array &$context) {
    //Get the source node.
   ...
   */
  public static function cloneContentTypeFinishedCallback(bool $success, array $results, array $operations) {
