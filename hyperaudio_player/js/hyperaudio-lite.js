    ...
    if (end && (end < player.currentTime)) {
      ...
      if (l > 0) {
        ...
        if (currentParaIndex != paraIndex) {
          var Vlc = null;
          if (typeof Velocity !== 'undefined') Vlc = Velocity;
          if (typeof $ !== 'undefined' && typeof $.Velocity !== 'undefined') Vlc = $.Velocity;
          if (typeof jQuery !== 'undefined' && typeof jQuery.Velocity !== 'undefined') Vlc = jQuery.Velocity;
